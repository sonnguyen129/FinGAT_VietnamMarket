...
def train_default(config: dict, config_path: str, resume_from: str = None):
    """
    ...
    # Prepare data (this will auto-detect input_dim)
    ...
    # Initialize model with auto-detected parameters
    print("\n2. Initializing model...")
    model = FinGAT(
        input_dim=model_config['input_dim'],
        num_stocks=model_config['num_stocks'],
        num_sectors=model_config['num_sectors'],
        config_manager=data_module.config_manager
    )
